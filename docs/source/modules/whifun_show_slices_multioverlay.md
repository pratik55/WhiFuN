...
### `volumes`
cell array of file paths or 3D matrices

### `overlay_types`
cell array: {'structure','contour',...}

### `cmaps`
cell array of colormaps for each image

### `slices`
array of slice indices (one per image)
...
Example: vols = {'sub1.nii','sub2.nii','sub3.nii'}; types = {'structure','contour','structure'}; cmaps = {hot, lines, gray}; slices = [40 45 50];
